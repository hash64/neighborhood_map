...
import * as LocationsAPI from "./MyLocation";
  ...
  render() {
    ...
    return (
      <div className="sideBars">
        {/*content*/}
        <Sidebar locations={this.state.locations} handleClick={this.handleClick} queryString={this.state.queryString} handleChange={this.handleInputChange} />
        <Map
